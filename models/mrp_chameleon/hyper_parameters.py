...
MODEL_NAME = "mrp_chameleon_5" # 5 for aggregation
CIPHER = 'AES'
...
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = 235_371 # Number of training examples
...
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = 25_569 # Number of validation examples
...
TRACES_PER_ATTACK = 130 # Maximum number of traces to use per attack
