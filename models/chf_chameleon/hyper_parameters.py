...
MODEL_NAME = "chf_chameleon_5" # 5 for aggregation
CIPHER = 'AES'
...
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = 214_788 # Number of training examples
...
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = 28_100 # Number of validation examples
...
TRACES_PER_ATTACK = 100 # Maximum number of traces to use per attack
